					...
					< [.g-hor-flex]
						< section.b-intro
							...
							< .&__desc
								...
								< p
									`Больше никакой ручной работы: IamGamer.pro реализует полный набор инструментов для таких рутинных операций, как приём в клан, планирование эвентов и рейдов, деление лута и крафта и т.д.`

								< p
									`Создавай союзы, объявляй войны и выведи свой клан в топ рейтинга IamGamer.`

								< p
									`IamGame.pro создаётся с целью дать приют всем тем, кто не представляет свою жизнь без компьютерных игр, а также для тех, кто просто интересуется игровой индустрией.`
